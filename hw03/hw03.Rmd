...
The table produced in this section lists the minimum and maximum GDP per capita for each continent between 1952-2007.  The plot will visualize (1) the minimum and maximum GDP per capita for each continent (described in the table above) and (2) the distribution of data, by displaying each data point. Data were acquired from the "gapminder" dataset included with R Statistical Software.
...
### Task 3
To better understand the spread of GDP per capita data , I first produced a summary table containing the mean, standard deviation, minimum, and maximum values for each continent. To visualize this spread, I opted to use boxplots, as they display the minimum, maximum, 25% quartile, 75% quartile and median of the data. Data were acquired from the "gapminder" dataset included with R Statistical Software.
